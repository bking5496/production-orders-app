-- Enhanced Production Workflow Database Schema for PostgreSQL
...
CREATE TABLE IF NOT EXISTS product_recipes (
    ...
    is_critical BOOLEAN DEFAULT false, -- Critical materials that must be checked
    notes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS workflow_progress (
    ...
    operator_id INTEGER,
    notes TEXT,
    data JSONB, -- Store stage-specific data (materials allocated, checklist status, etc.)
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO materials (code, name, unit_of_measure, supplier, current_stock) VALUES
...
INSERT INTO setup_checklists (name, task_description, sequence_order, estimated_time_minutes) VALUES
...
INSERT INTO quality_checkpoints (checkpoint_name, checkpoint_stage, target_value, tolerance_min, tolerance_max, unit_of_measure) VALUES
